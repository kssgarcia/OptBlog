---
title: "SIMP optimization code"
date: 2023-05-17T11:48:52-05:00
draft: false
math: true 
---

This post will present a code implemented in Python for the topology optimization method SIMP.

First, let’s consider the next [steps](https://kssgarcia.github.io/posts/simp/) to make the algorithm:
...
The code can be found in the [github](https://github.com/kssgarcia/OptTopolgy) repository.

![Gif result](/SIMPani1.gif)
![Gif result](/SIMPani2.gif)

These are some of the results returned by the code for two beams subjected to a vertical load.
